...
assert "anyone who might know enough to actually do it" in results[0].page_content
...
retriever = BuildRetriever(
    db_dir, "R-help", "sparse", top_k=6, start_year=2025, end_year=2025, months=["Dec"]
)
...
retriever = BuildRetriever(
    db_dir, "R-help", "dense", top_k=6, start_year=2025, end_year=2025, months=["Oct"]
)
